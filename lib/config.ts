export const CONFIG = {
  ...
  packages: [
    ...
    },
    {
      ...
      originalPrice: 474,
      totalPrice: 294,
      shipping: "FREE India Shipping",
      shippingFee: 0,
      popular: false,
      bestValue: true,
      savings: 180,
      description: "Our recommended package. Rejuvenates joint fluid completely and locks in the lowest rate.",
      bonuses: [
